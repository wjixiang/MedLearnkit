import {hasNullValue} from './lib/utils'
...
function get_mode(frame) {
  for (let i = 0; i < frame.children().length; i++) {
    ...
    if (
      a != null &&
      a.className() == "android.view.ViewGroup" &&
      a.childCount() > 0
    ) {
      // 检查子元素数量
...
function get_answer(frame) {
  for (let i = 0; i < frame.children().length; i++) {
    ...
    if (
      a != null &&
      a.className() == "android.widget.LinearLayout" &&
      a.childCount() > 0
    ) {
      // 检查子元素数量
      for (let j = 0; j < a.children().length; j++) {
        ...
        if (
          b != null &&
          b.className() == "android.widget.RelativeLayout" &&
          b.childCount() > 0
        ) {
          // 检查子元素数量
          for (let k = 0; k < b.children().length; k++) {
            ...
            if (
              d != null &&
              d.id() == "com.yikaobang.yixue:id/questiondetails_tv_Answer"
            ) {
              console.log(d.text());
...
function get_option(frame) {
  ...
  for (let i = 0; i < frame.children().length; i++) {
    ...
    if (
      a != null &&
      a.className() == "androidx.recyclerview.widget.RecyclerView" &&
      a.childCount() > 0
    ) {
      // 检查子元素数量
      for (let j = 0; j < a.children().length; j++) {
  ...
  for (let i = 0; i < frame.children().length; i++) {
    ...
    if (
      ...
      for (let j = 0; j < a.children().length; j++) {
        ...
        if (
          b != null &&
          b.className() == "android.widget.LinearLayout" &&
          b.childCount() > 0
        ) {
          // 检查子元素数量
          for (let k = 0; k < b.children().length; k++) {
            ...
            if (c != null) {
              if (
                c.className() == "android.widget.LinearLayout" &&
                c.childCount() > 0
              ) {
                // 检查子元素数量
                for (let l = 0; l < c.children().length; l++) {
                  ...
                  if (
                    d != null &&
                    d.id() ==
                      "com.yikaobang.yixue:id/questiondetails_tv_content_ques1"
                  ) {
                    console.log(d.text());
                    return d.text();
                  }
          ...
          for (let k = 0; k < b.children().length; k++) {
            ...
            if (
              ...
              for (let l = 0; l < c.children().length; l++) {
                ...
                if (
                  d != null &&
                  d.id() == "com.yikaobang.yixue:id/questiondetails_tv_contents"
                ) {
                  console.log(d.text());
                  return d.text();
                }
